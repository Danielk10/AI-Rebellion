...
public class ClienteBluetooth extends AppCompatActivity {
                        ...
                        if (dispositivo != null) {
                            ...
                            if (encontrado) {
                                ...
                                if (dispositivos.get(i) != null) {
                                    ...
                                    TextView texto = new TextView(ClienteBluetooth.this);

                                    texto.setText(dispositivos.get(i).getName());

                                    Button boton = new Button(ClienteBluetooth.this);
